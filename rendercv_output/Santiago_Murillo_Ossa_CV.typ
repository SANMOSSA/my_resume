...
#let connections-list = (
  [#box(original-link("mailto:murillosantiago157@gmail.com")[#fa-icon("envelope", size: 0.9em) #h(0.05cm)murillosantiago157\@gmail.com])],
  [#box(original-link("https://sanmossa.org/")[#fa-icon("link", size: 0.9em) #h(0.05cm)sanmossa.org])],
  [#box(original-link("https://github.com/SANMOSSA")[#fa-icon("github", size: 0.9em) #h(0.05cm)SANMOSSA])],
)
...
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Cloud - Azure - Microsoft:] Azure AI Foundry, Azure Blob Storage, Azure Web Apps, Power Automate]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Cloud - Google:] Firestore, Realtime Database]
)
